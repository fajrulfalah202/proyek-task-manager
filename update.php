...
join mobil on transaksi.id_mobil=mobil.id_mobil  where transaksi.id_transaksi = '$id_transaksi'" );
            ...
            <div class="card-body">
                ...
                <form action="sql/update.php" method="post"  enctype="multipart/form-data">
                    <div class="form-floating mb-3">
                        <input type="text" class="form-control" value="<?php echo $d['id_transaksi'];?> " id="id_konsumen" name="id_konsumen" placeholder="1203210093" required>
                        <label for="id_konsumen">id_produksi</label>
                    </div>
                    <div class="form-floating mb-3">
                        <input type="text" class="form-control" value="<?php echo $d['id_konsumen'];?> " id="id_konsumen" name="id_konsumen" placeholder="1203210093" required>
                        <label for="id_konsumen">id_konsumen</label>
                    </div>
                    
                    <div class="form-floating mb-3">
                    <?php
                      $acr5 = "SELECT * from karyawan where id_karyawan = '{$d['id_karyawan']}'";
                      $hasil5 = mysqli_query($konek, $acr5);
                      $mob3 = mysqli_fetch_array($hasil5);
                      ?>
                      <select class="form-select" id="floatingSelect" aria-label="Floating label select example" name="id_karyawan" required>
                          <option  selected><?php echo $mob3['nama'];?></option>
                    ...
                    <div class="form-floating mb-3">
                      <input type="text" class="form-control" id="id_mobil" value=" <?php echo $d['id_mobil']; ?>" name="id_mobil" placeholder="1203210093" required>
                      <label for="id_mobil">id mobil</label>
                  </div>

                  <div class="form-floating mb-3">
                    <input type="text" class="form-control" id="nopol" name="nopol" value="<?php echo $d['nopol'];?>" placeholder="1203210093" required>
                    <label for="nopol">nomer polisi</label>
                </div>
                  <div class="form-floating mb-3">
                    <input type="text" class="form-control" id="kapasitas" name="kapasitas" value="<?php echo $d['kapasitas'];?>" placeholder="1203210093" required>
                    <label for="kapasitas">kapasitas</label>
                </div>
                  <div class="form-floating mb-3">
                    <input type="text" class="form-control" id="harga" name="harga" value="<?php echo $d['harga'];?>" placeholder="1203210093" required>
                  ...
                  <div class="form-floating mb-3">
                  <?php
                      $acr3 = "SELECT * from kategori where id_kategori = '{$d['id_kategori']}'";
                      $hasil4 = mysqli_query($konek, $acr3);
                      $mob2 = mysqli_fetch_array($hasil4);
                      ?>
                    <select class="form-select" id="floatingSelect" aria-label="Floating label select example" name="id_kategori" required>
                        <option selected><?php echo $mob2['kategori'];?></option>
                    ...
                    <div class="form-floating mb-3">
                    <?php
                      $acr2 = "SELECT * from mobil where id_mobil = '{$d['id_mobil']}'";
                      $hasil3 = mysqli_query($konek, $acr2);
                      $mob = mysqli_fetch_array($hasil3);
                      ?>
                        <select class="form-select" id="floatingSelect"  value = "<?php echo $mob['id_mobil'];?> aria-label="Floating label select example" name="merk" required>
                            <option selected><?php echo $mob['merk'];?></option>
                    ...
                    <div class="form-floating mb-3">
                      <?php
                      $acr = "SELECT * from supir where id_supir = '{$d['id_supir']}'";
                      $hasil2 = mysqli_query($konek, $acr);
                      ...
                      <select class="form-select" id="floatingSelect" aria-label="Floating label select example" name="id_supir" required>
                          <option selected ><?php echo $t['nama'];?></option>
                  ...
                  <!-- -------------------------- -->
                  <div class="form-floating mb-3">
                    <input type="date" class="form-control" id="tgl_pinjam" name="tgl_pinjam" value="<?php echo $d['tgl_pinjam'];?>" placeholder="1203210093" required>
                    <label for="tgl_pinjam">tgl pinjam</label>
                </div>
                  <div class="form-floating mb-3">
                    <input type="date" class="form-control" id="tgl_kembali" name="tgl_kembali" value="<?php echo $d['tgl_kembali'];?>" placeholder="1203210093" required>
                    <label for="tgl_kembali">tgl kembali</label>
                </div>
                <!-- ------------------------------------------------- -->
              
                <div class="form-floating mb-3">
                  <input type="text" class="form-control" id="id_status" value="<?php echo $d['id_status'];?>" name="id_status" placeholder="1203210093" required>
                  <label for="id_status">id status</label>
              </div>
                <div class="form-floating mb-3">
                  <input type="text" class="form-control" id="status_sebelum" value="<?php echo $d['status_sebelum'];?>" name="status_sebelum" placeholder="1203210093" required>
                  <label for="status_sebelum">kondisi sebelum</label>
              </div>
                <div class="form-floating mb-3">
                  <input type="text" class="form-control" id="status_setelah" value="<?php echo $d['status_sesudah'];?>" name="status_setelah" placeholder="1203210093" required>
                  <label for="status_setelah">kondisi setelah</label>
              </div>

              <div class="form-floating mb-3">
                <input type="text" class="form-control" id="denda" value ="0" name="denda"  value="<?php echo $d['denda'];?>"placeholder="1203210093" required>
